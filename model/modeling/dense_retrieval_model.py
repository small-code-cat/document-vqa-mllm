...
from model.modeling.modeling_siglip.processing_siglip import SiglipProcessor
    ...
    def build(
        ...
        **hf_kwargs,
        ...
        if "siglip" in name or "SigLIP" in name:
            logging.info("using SIGLIP model, load modeling from model.modeling.modeling_siglip")
            from model.modeling.modeling_siglip.configuration_siglip import SiglipConfig as config_cls
            from model.modeling.modeling_siglip.configuration_siglip import SiglipTextConfig, SiglipVisionConfig
            from model.modeling.modeling_siglip.modeling_siglip import SiglipModel as model_class
        elif "MiniCPM-V-2" in name or "VisRAG" in name:
            from model.modeling.modeling_visrag_ret.modeling_visrag_ret import VisRAG_Ret as model_class
            from model.modeling.modeling_minicpmv.modeling_minicpmv import MiniCPMVConfig as config_cls
        else: # other model
